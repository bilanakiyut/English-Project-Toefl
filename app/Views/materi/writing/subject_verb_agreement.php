...
<body>
    ...
    <div class="materi-header">
        ...
        <p>Understanding the fundamental rule where the subject and verb must match in number.</p>
    </div>
    ...
    <div class="materi-wrapper">
        <div class="materi-left-scroll">
            <div class="main-card">
                ...
                <p class="intro">Subject-verb agreement adalah aturan bahwa subject dan verb harus sesuai jumlahnya. <strong>Subject singular</strong> membutuhkan verb singular, sedangkan <strong>subject plural</strong> membutuhkan verb plural.</p>

                <div class="sub-section">
                    <h3>What is Subject-Verb Agreement?</h3>
                    <p>Dalam simple present tense, subject singular biasanya memakai verb dengan akhiran <em>-s/-es</em>, sedangkan subject plural memakai base form verb.</p><p>✅ <strong>She works</strong> → singular subject + singular verb.<br>✅ <strong>They work</strong> → plural subject + base verb.<br>❌ <strong>She work</strong> dan <strong>They works</strong> adalah bentuk yang salah.</p>
                </div>
                ...
                <div class="sub-section">
                    ...
                    <div class="comparison-box">
                        <p>
                            ...
                            <span class="text-wrong">Incorrect:</span> The <strong>quality</strong> of the apples <strong>are</strong> excellent.<br>
                            <span class="text-correct">Correct:</span> The <strong>quality</strong> of the apples <strong>is</strong> excellent.
                        </p>
                    </div>
                    <div class="comparison-box" style="margin-top: 15px;">
                        <p>
                            <span class="badge-tag">Example 2</span><br>
                            <span class="text-wrong">Incorrect:</span> Each of the <strong>students</strong> <strong>have</strong> a book.<br>
                            <span class="text-correct">Correct:</span> Each of the <strong>students</strong> <strong>has</strong> a book.
                        </p>
                    </div>
                    <div class="comparison-box" style="margin-top: 15px;">
                        <p>
                            <span class="badge-tag">Example 3</span><br>
                            <span class="text-wrong">Incorrect:</span> The <strong>box</strong> of books <strong>are</strong> missing.<br>
                            <span class="text-correct">Correct:</span> The <strong>box</strong> of books <strong>is</strong> missing.
                        </p>
                    </div>
                </div>
                ...
                <div class="tip-box">
                    ...
                    <p>Cari subject utama terlebih dahulu. Coret frasa tambahan seperti <em>of..., in..., with...</em>. Setelah subject asli terlihat, cocokkan verb dengan bentuk singular atau pluralnya.</p>
                </div>
            </div>
...
<button class="ex-tab" data-target="ex3">TOEFL Trap</button>
                    ...
                    <div class="example-slide active" id="ex1">
                        <div class="sentence-box">
                            The <span class="hl-modal">manager</span> <span class="hl-base">makes</span> a final decision today.
                        </div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box">
                                <div class="box-label">Subject</div>
                                <div class="box-value">manager</div>
                                <div class="box-desc">Subject singular orang ketiga membutuhkan verb dengan akhiran -s/-es.</div>
                            </div>
                            <div class="analysis-box elem-box">
                                <div class="box-label">Verb</div>
                                <div class="box-value">makes</div>
                                <div class="box-desc">Verb sudah sesuai karena <em>manager</em> adalah singular.</div>
                            </div>
                        </div>
                    </div>
                    <div class="example-slide" id="ex2">
                        <div class="sentence-box">
                            All <span class="hl-modal">employees</span> <span class="hl-base">need</span> to attend the meeting.
                        </div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box">
                                <div class="box-label">Subject</div>
                                <div class="box-value">employees</div>
                                <div class="box-desc">Subject plural memakai base form verb tanpa -s/-es.</div>
                            </div>
                            <div class="analysis-box elem-box">
                                <div class="box-label">Verb</div>
                                <div class="box-value">need</div>
                                <div class="box-desc">Verb sudah sesuai karena <em>employees</em> adalah plural.</div>
                            </div>
                        </div>
                    </div>
                    <div class="example-slide" id="ex3">
                        <div class="sentence-box">
                            The <span class="hl-modal">box</span> of documents <span class="hl-base">is</span> missing.
                        </div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box">
                                <div class="box-label">True Subject</div>
                                <div class="box-value">box</div>
                                <div class="box-desc">Subject asli adalah <em>box</em>, bukan <em>documents</em>.</div>
                            </div>
                            <div class="analysis-box elem-box">
                                <div class="box-label">Correct Verb</div>
                                <div class="box-value">is</div>
                                <div class="box-desc">Karena <em>box</em> singular, verb yang benar adalah <em>is</em>.</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="quiz-section" class="quiz-section">
                <div class="practice-header-card">Subject-Verb Agreement Quiz</div>
                <div class="quiz-body">
                    
                    <div class="question-wrapper" data-step="1" style="display: block;">
                        <div class="quiz-progress">1/5</div>
                        <p class="question-text">" The list of items ______ on the desk, waiting to be reviewed by the supervisor. "</p>
...
<li class="option-item" data-correct="false">D. been</li>
                    ...
                    <div class="question-wrapper" data-step="2" style="display: none;">
                        ...
                        <p class="question-text">" Neither the students nor the teacher ______ attending the conference this afternoon. "</p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="false">A. were</li>
<li class="option-item" data-correct="false">B. are</li>
...
<li class="option-item" data-correct="false">D. have</li>
                    ...
                    <div class="question-wrapper" data-step="3" style="display: none;">
                        ...
                        <p class="question-text">" Everyone who ______ the requirements is eligible to apply for the scholarship. "</p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="true">A. meets</li>
<li class="option-item" data-correct="false">B. meet</li>
<li class="option-item" data-correct="false">C. meeting</li>
<li class="option-item" data-correct="false">D. have met</li>
                    ...
                    <div class="question-wrapper" data-step="4" style="display: none;">
                        ...
                        <p class="question-text" style="font-style: normal;"><strong>Identify the ERROR:</strong><br><br>The <span class="error-underline">quality</span><span class="error-label">A</span> of the <span class="error-underline">imported</span><span class="error-label">B</span> goods <span class="error-underline">are</span><span class="error-label">C</span> far superior to local <span class="error-underline">alternatives</span><span class="error-label">D</span>.</p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="false">A. quality</li>
<li class="option-item" data-correct="false">B. imported</li>
<li class="option-item" data-correct="true">C. are</li>
<li class="option-item" data-correct="false">D. alternatives</li>
                    ...
                    <div class="question-wrapper" data-step="5" style="display: none;">
                        ...
                        <p class="question-text" style="font-style: normal;"><strong>Identify the ERROR:</strong><br><br>Either the <span class="error-underline">manager</span><span class="error-label">A</span> or the <span class="error-underline">employees</span><span class="error-label">B</span> <span class="error-underline">is</span><span class="error-label">C</span> responsible for the <span class="error-underline">mess</span><span class="error-label">D</span>.</p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="false">A. manager</li>
<li class="option-item" data-correct="false">B. employees</li>
<li class="option-item" data-correct="true">C. is</li>
<li class="option-item" data-correct="false">D. mess</li>
        ...
        <div class="materi-right-sticky">
            <div class="pattern-card">
                <h3>🔒 S-V Agreement Key</h3>
                
                    <div class="summary-box">
                        <strong>The Golden Rule</strong>
                        A singular subject takes a singular verb, and a plural subject takes a plural verb.
                        <span>Singular + Verb-s/es | Plural + Base Verb</span>
                    </div>
                    <div class="summary-box">
                        <strong>Subject Categories</strong>
                        Singular: he, she, it, name, each, everyone. Plural: we, they, plural nouns.
                        <span>She walks | They walk</span>
                    </div>
                    <div class="summary-box">
                        <strong>Quick Verification</strong>
                        Ignore prepositional phrases between the subject and the verb.
                        <span>The box [of books] is</span>
                    </div>
            ...
            <div class="video-card">
                ...
                <div class="video-container">
                    <iframe src="https://www.youtube.com/embed/CiYicrb8kOo" title="Video Lesson" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        const quizDatabase = {
            1: {
                correctText: `Correct! The true subject is <em>list</em>, which is singular. The phrase <em>of items</em> does not change the subject.`,
                wrongText: `Do not be tricked by <em>items</em>. It is inside a prepositional phrase. The subject is <em>list</em>.`,
                formula: `Singular Subject (list) + [of items] → Singular Verb (is)`
            },
            2: {
                correctText: `Spot on! With <em>neither...nor</em>, the verb agrees with the closest subject. Here, <em>teacher</em> is closest and singular, so use <strong>is</strong>.`,
                wrongText: `For <em>neither...nor</em>, check the noun closest to the verb. Since <em>teacher</em> is singular, the verb must be singular.`,
                formula: `Neither A nor B (teacher) → is`
            },
            3: {
                correctText: `Excellent! <em>Everyone</em> is always singular, so the verb must use the singular form <strong>meets</strong>.`,
                wrongText: `Indefinite pronouns such as <em>everyone, someone, each, neither</em> are treated as singular.`,
                formula: `Everyone + Verb-s/es → Everyone meets`
            },
            4: {
                correctText: `Correct! The error is C (<em>are</em>). The subject is <em>quality</em> (singular), so the verb should be <strong>is</strong>.`,
                wrongText: `The noun <em>goods</em> is not the subject. It is part of the phrase <em>of the imported goods</em>.`,
                formula: `quality + [of goods] + <span style="color:#E74C3C;">are</span> → <span style="color:#27AE60;">is</span>`
            },
            5: {
                correctText: `Perfect! With <em>either...or</em>, the verb agrees with the closest subject. <em>Employees</em> is plural, so the verb should be <strong>are</strong>.`,
                wrongText: `The closest subject before the verb is <em>employees</em>, not <em>manager</em>. Therefore the verb must be plural.`,
                formula: `Either manager or employees + <span style="color:#E74C3C;">is</span> → <span style="color:#27AE60;">are</span>`
            }
        };
        ...
        btnNext.addEventListener('click', function () {
            ...
            if (currentStep <= 5) {
                ...
                alert('🎉 Great! You have mastered Subject-Verb Agreement.');
                currentStep = 1;
