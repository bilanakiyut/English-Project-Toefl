...
<head>
    ...
    <title>Agreement After Certain Words</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 992px) {
            ...
            nav { padding: 20px; justify-content: center; flex-wrap: wrap; }
...
<body>
    ...
    <div class="materi-header">
        <h1>Agreement After Certain Words</h1>
        <p>Mastering subject-verb agreement when inclusion phrases separate the subject and the verb.</p>
    </div>

    <div class="materi-wrapper">
        <div class="materi-left-scroll">
            <div class="main-card">
                <h2>The Inclusion Phrase Trap</h2>
                <p class="intro">Dalam TOEFL Structure, beberapa kata seperti <strong>along with, as well as, together with, accompanied by,</strong> dan <strong>in addition to</strong> sering menjadi pengecoh. Kata-kata ini menambahkan informasi, tetapi <strong>tidak mengubah jumlah subject utama</strong>.</p>

                <div class="sub-section">
                    <h3>What is Agreement After Certain Words?</h3>
                    <p>Agreement after certain words adalah aturan ketika subject utama diikuti frasa tambahan. Verb tetap harus mengikuti subject utama, bukan noun yang berada di dalam frasa tambahan.</p><p>✅ <strong>Subject singular</strong> → verb singular.<br>✅ <strong>Subject plural</strong> → verb plural.<br>❌ Jangan mengikuti noun setelah <em>along with, as well as, together with,</em> atau <em>in addition to</em>.</p>
                </div>

                <div class="sub-section">
                    <h3>TOEFL Style Comparison Examples</h3>
                    <p>Perhatikan contoh salah dan benar berikut agar pola agreement lebih mudah dikenali.</p>
                    
                    <div class="comparison-box">
                        <p>
                            <span class="badge-tag">Example 1</span><br>
                            <span class="text-wrong">Incorrect:</span> The <strong>director</strong>, along with the staff, <strong>are</strong> in the room.<br>
                            <span class="text-correct">Correct:</span> The <strong>director</strong>, along with the staff, <strong>is</strong> in the room.
                        </p>
                    </div>
                    <div class="comparison-box" style="margin-top: 15px;">
                        <p>
                            <span class="badge-tag">Example 2</span><br>
                            <span class="text-wrong">Incorrect:</span> The <strong>documents</strong>, in addition to the receipt, <strong>was</strong> signed.<br>
                            <span class="text-correct">Correct:</span> The <strong>documents</strong>, in addition to the receipt, <strong>were</strong> signed.
                        </p>
                    </div>
                    <div class="comparison-box" style="margin-top: 15px;">
                        <p>
                            <span class="badge-tag">Example 3</span><br>
                            <span class="text-wrong">Incorrect:</span> The <strong>policy</strong>, as well as the rules, <strong>are</strong> effective today.<br>
                            <span class="text-correct">Correct:</span> The <strong>policy</strong>, as well as the rules, <strong>is</strong> effective today.
                        </p>
                    </div>
                </div>
                ...
                <div class="tip-box">
                    ...
                    <p>Jika menemukan frasa <em>along with, as well as, together with, accompanied by,</em> atau <em>in addition to</em>, coret sementara frasa tersebut. Setelah itu cocokkan verb dengan subject utama sebelum frasa.</p>
                </div>
            </div>
            ...
            <div id="examples-display-section" class="examples-display-section">
                <div class="example-showcase-card">
                    <h3>Agreement Pattern Analysis</h3>
                    <div class="example-nav">
                        <button class="ex-tab active" data-target="ex1">Along With</button>
<button class="ex-tab" data-target="ex2">As Well As</button>
<button class="ex-tab" data-target="ex3">TOEFL Trap</button>
                    ...
                    <div class="example-slide active" id="ex1">
                        <div class="sentence-box">
                            The <span class="hl-modal">director</span>, along with the staff, <span class="hl-base">is</span> in the meeting.
                        </div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box">
                                <div class="box-label">Main Subject</div>
                                <div class="box-value">director</div>
                                <div class="box-desc">Subject utama singular, sehingga verb harus singular.</div>
                            </div>
                            <div class="analysis-box elem-box">
                                <div class="box-label">Distractor Phrase</div>
                                <div class="box-value">along with the staff</div>
                                <div class="box-desc">Frasa ini hanya informasi tambahan dan tidak membuat subject menjadi plural.</div>
                            </div>
                        </div>
                    </div>
                    <div class="example-slide" id="ex2">
                        <div class="sentence-box">
                            The <span class="hl-modal">results</span>, as well as the file, <span class="hl-base">are</span> accurate.
                        </div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box">
                                <div class="box-label">Main Subject</div>
                                <div class="box-value">results</div>
                                <div class="box-desc">Subject utama plural, sehingga verb harus plural.</div>
                            </div>
                            <div class="analysis-box elem-box">
                                <div class="box-label">Distractor Phrase</div>
                                <div class="box-value">as well as the file</div>
                                <div class="box-desc">Kata <em>file</em> singular tidak memengaruhi verb karena berada di frasa tambahan.</div>
                            </div>
                        </div>
                    </div>
                    <div class="example-slide" id="ex3">
                        <div class="sentence-box">
                            The <span class="hl-modal">policy</span>, in addition to the rules, <span class="hl-base">is</span> effective.
                        </div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box">
                                <div class="box-label">True Subject</div>
                                <div class="box-value">policy</div>
                                <div class="box-desc">Subject asli adalah <em>policy</em>, bukan <em>rules</em>.</div>
                            </div>
                            <div class="analysis-box elem-box">
                                <div class="box-label">Correct Verb</div>
                                <div class="box-value">is</div>
                                <div class="box-desc">Karena <em>policy</em> singular, verb yang benar adalah <em>is</em>.</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="quiz-section" class="quiz-section">
                <div class="practice-header-card">Agreement After Certain Words Quiz</div>
                <div class="quiz-body">
                    
                    <div class="question-wrapper" data-step="1" style="display: block;">
                        <div class="quiz-progress">1/5</div>
                        <p class="question-text">" The manager, along with his assistants, ______ attending the conference today. "</p>
...
<li class="option-item" data-correct="false">D. be</li>
                    ...
                    <div class="question-wrapper" data-step="2" style="display: none;">
                        ...
                        <p class="question-text">" The results of the experiment, as well as the summary, ______ ready for review. "</p>
                        <ul class="options-grid">
...
<li class="option-item" data-correct="false">D. has</li>
                    ...
                    <div class="question-wrapper" data-step="3" style="display: none;">
                        ...
                        <p class="question-text">" The captain, together with his crew, ______ waiting at the port for the signal. "</p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="true">A. was</li>
<li class="option-item" data-correct="false">B. were</li>
<li class="option-item" data-correct="false">C. have</li>
<li class="option-item" data-correct="false">D. been</li>
                    ...
                    <div class="question-wrapper" data-step="4" style="display: none;">
                        ...
                        <p class="question-text" style="font-style: normal;"><strong>Identify the ERROR:</strong><br><br>The <span class="error-underline">policy</span><span class="error-label">A</span>, along with <span class="error-underline">the new rules</span><span class="error-label">B</span>, <span class="error-underline">are</span><span class="error-label">C</span> effective <span class="error-underline">immediately</span><span class="error-label">D</span>.</p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="false">A. policy</li>
<li class="option-item" data-correct="false">B. the new rules</li>
<li class="option-item" data-correct="true">C. are</li>
<li class="option-item" data-correct="false">D. immediately</li>
                    ...
                    <div class="question-wrapper" data-step="5" style="display: none;">
                        ...
                        <p class="question-text" style="font-style: normal;"><strong>Identify the ERROR:</strong><br><br>The <span class="error-underline">documents</span><span class="error-label">A</span>, in addition to <span class="error-underline">the receipt</span><span class="error-label">B</span>, <span class="error-underline">was</span><span class="error-label">C</span> <span class="error-underline">signed</span><span class="error-label">D</span>.</p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="false">A. documents</li>
<li class="option-item" data-correct="false">B. the receipt</li>
<li class="option-item" data-correct="true">C. was</li>
<li class="option-item" data-correct="false">D. signed</li>
        ...
        <div class="materi-right-sticky">
            <div class="pattern-card">
                <h3>🔍 Quick Identification</h3>
                    ...
                    <div class="summary-box">
                        <strong>Certain Words</strong>
                        along with, as well as, together with, accompanied by, in addition to.
                        <span>Subject + [Certain Words + Phrase] + Verb</span>
                    </div>
                    <div class="summary-box">
                        <strong>Main Rule</strong>
                        Verb mengikuti subject utama sebelum frasa tambahan, bukan noun di dalam frasa.
                        <span>The director + [along with staff] + is</span>
                    </div>
                    <div class="summary-box">
                        <strong>TOEFL Trap</strong>
                        Noun di dalam frasa sering dibuat berbeda jumlahnya untuk mengecoh jawaban.
                        <span>Ignore the distractor phrase</span>
                    </div>
                <span style="font-size: 0.95rem; opacity: 0.85; display: block; margin-top: 15px; text-align: center; font-style: italic;">
                    Focus on the main subject before choosing the verb.
                </span>
            </div>
            ...
            <div class="video-card">
                ...
                <div class="video-container">
                    <iframe src="https://www.youtube.com/embed/QFsrnaqLrg4" title="Video Lesson" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        const quizDatabase = {
            1: {
                correctText: `Correct! The main subject is <em>the manager</em> (singular). The phrase <em>along with his assistants</em> is only extra information, so the verb must be <strong>is</strong>.`,
                wrongText: `Do not let <em>assistants</em> trick you. With phrases like <em>along with</em>, the verb follows the main subject before the phrase.`,
                formula: `Singular Subject + [along with + phrase] → Singular Verb`
            },
            2: {
                correctText: `Spot on! The main subject is <em>the results</em> (plural). The phrase <em>as well as the summary</em> does not change the subject.`,
                wrongText: `The verb does not agree with <em>summary</em>. It agrees with <em>results</em>, which is plural.`,
                formula: `Plural Subject + [as well as + phrase] → Plural Verb`
            },
            3: {
                correctText: `Brilliant! <em>The captain</em> is singular, so the correct verb is <strong>was</strong>. The phrase <em>together with his crew</em> is a distractor.`,
                wrongText: `The word <em>crew</em> is inside an inclusion phrase. Focus on <em>captain</em>, the true subject.`,
                formula: `Singular Subject + [together with + phrase] → Singular Verb`
            },
            4: {
                correctText: `Correct! The error is C (<em>are</em>). The subject <em>policy</em> is singular, so the verb should be <strong>is</strong>.`,
                wrongText: `The phrase <em>along with the new rules</em> is extra information. The verb must agree with <em>policy</em>, not <em>rules</em>.`,
                formula: `policy + [along with rules] + <span style="color:#E74C3C;">are</span> → <span style="color:#27AE60;">is</span>`
            },
            5: {
                correctText: `Perfect! The error is C (<em>was</em>). The main subject <em>documents</em> is plural, so the correct verb is <strong>were</strong>.`,
                wrongText: `The phrase <em>in addition to the receipt</em> should be ignored. The verb must agree with <em>documents</em>.`,
                formula: `documents + [in addition to receipt] + <span style="color:#E74C3C;">was</span> → <span style="color:#27AE60;">were</span>`
            }
        };
        ...
        btnExamples.addEventListener('click', function () {
            ...
            if (examplesSec.style.display === 'flex') {
                ...
                examplesSec.scrollIntoView({ behavior: 'smooth', block: 'start' });
            }
        });
        ...
        btnNext.addEventListener('click', function () {
            ...
            if (currentStep <= 5) {
                ...
                alert('🎉 Great! You have mastered Agreement After Certain Words.');
                currentStep = 1;
                document.querySelectorAll('.question-wrapper').forEach(w => {
                    ...
                    const formulaBox = w.querySelector('.inner-formula-box');
