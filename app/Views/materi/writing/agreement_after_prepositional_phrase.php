...
<head>
    ...
    <title>Agreement After Prepositional Phrases</title>
...
<body>
    ...
    <div class="materi-header">
        <h1>Agreement After Prepositional Phrases</h1>
        <p>Mastering subject-verb agreement when the subject is separated from the verb by a prepositional phrase.</p>
    </div>
    ...
    <div class="materi-wrapper">
        ...
        <div class="materi-left-scroll">
            ...
            <div class="main-card">
                <h2>The Agreement Trap</h2>
                <p class="intro">Dalam TOEFL Structure, subject sering dipisahkan dari verb oleh <strong>prepositional phrase</strong> seperti <em>of the students, in the room, with many pages, to the car</em>. Verb tetap harus mengikuti <strong>subject utama</strong>, bukan noun yang berada di dalam prepositional phrase.</p>

                <div class="sub-section">
                    <h3>What is a Prepositional Phrase?</h3>
                    <p>Prepositional phrase adalah kelompok kata yang diawali preposition seperti <em>of, in, on, at, with, by, to, from, for</em>. Bagian ini hanya menjadi informasi tambahan, sehingga tidak menentukan bentuk verb.</p>
                    <p>
                        ✅ The <strong>box</strong> of chocolates <strong>is</strong> on the table. <br>
                        ✅ The <strong>keys</strong> to the car <strong>were</strong> missing. <br>
                        ✅ The <strong>quality</strong> of the products <strong>is</strong> excellent. <br>
                        ❌ The quality of the products <strong>are</strong> excellent.
                    </p>
                </div>

                <div class="sub-section">
                    <h3>TOEFL Style Comparison Examples</h3>
                    <p>Perhatikan struktur pengecoh yang sering muncul di soal TOEFL Written Expression:</p>

                    <div class="comparison-box">
                        <p>
                            <span class="badge-tag">Example 1</span><br>
                            <span class="text-wrong">Incorrect:</span> The box of chocolates <strong>are</strong> on the table.<br>
                            <span class="text-correct">Correct:</span> The box of chocolates <strong>is</strong> on the table.
                        </p>
                    </div>
                    ...
                    <div class="comparison-box" style="margin-top: 15px;">
                        <p>
                            ...
                            <span class="text-wrong">Incorrect:</span> The quality of the products <strong>are</strong> excellent.<br>
                            <span class="text-correct">Correct:</span> The quality of the products <strong>is</strong> excellent.
                        </p>
                    </div>
                </div>
                ...
                <div class="tip-box">
                    ...
                    <p>Jika kamu menemukan phrase seperti <em>of chocolates, in the class, with many pages</em>, coret sementara bagian itu. Cari subject utama sebelum phrase, lalu sesuaikan verb dengan subject tersebut. Polanya: <strong>Subject + (Prepositional Phrase) + Verb</strong>.</p>
                </div>
            </div>
            ...
            <div id="examples-display-section" class="examples-display-section">
                ...
                <div class="example-showcase-card">
                    <h3>Bagan Analisis Subject + Prepositional Phrase + Verb</h3>

                    <div class="example-nav">
                        <button class="ex-tab active" data-target="ex1">Singular Subject</button>
                        <button class="ex-tab" data-target="ex2">Plural Subject</button>
                        <button class="ex-tab" data-target="ex3">TOEFL Trap</button>
                    </div>

                    <div class="example-slide active" id="ex1">
                        <div class="sentence-box">
                            The <span class="hl-modal">box</span> of chocolates <span class="hl-base">is</span> open.
                        </div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box">
                                <div class="box-label">Main Subject</div>
                                <div class="box-value">box</div>
                                <div class="box-desc">Subject utama adalah <em>box</em>, bukan <em>chocolates</em>. Karena <em>box</em> singular, verb yang benar adalah <strong>is</strong>.</div>
                            </div>
                            <div class="analysis-box elem-box">
                                <div class="box-label">Prepositional Phrase</div>
                                <div class="box-value">of chocolates</div>
                                <div class="box-desc">Phrase ini hanya informasi tambahan. Kata <em>chocolates</em> plural tidak memengaruhi verb.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="example-slide" id="ex2">
                        <div class="sentence-box">
                            The <span class="hl-modal">keys</span> to the car <span class="hl-base">were</span> lost yesterday.
                        </div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box">
                                <div class="box-label">Main Subject</div>
                                <div class="box-value">keys</div>
                                <div class="box-desc">Subject utama adalah <em>keys</em>. Karena subject plural, verb yang sesuai adalah <strong>were</strong>.</div>
                            </div>
                            <div class="analysis-box elem-box">
                                <div class="box-label">Prepositional Phrase</div>
                                <div class="box-value">to the car</div>
                                <div class="box-desc">Phrase <em>to the car</em> tidak menentukan verb. Jangan memilih <em>was</em> hanya karena ada kata <em>car</em>.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="example-slide" id="ex3">
                        <div class="sentence-box">
                            The <span class="hl-modal">quality</span> of the products <span class="hl-base">is</span> excellent.
                        </div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box">
                                <div class="box-label">Main Subject</div>
                                <div class="box-value">quality</div>
                                <div class="box-desc"><em>Quality</em> adalah subject utama dan bentuknya singular. Maka verb harus singular: <strong>is</strong>.</div>
                            </div>
                            <div class="analysis-box elem-box">
                                <div class="box-label">TOEFL Distractor</div>
                                <div class="box-value">of the products</div>
                                <div class="box-desc">Kata <em>products</em> plural hanya pengecoh. Verb tidak mengikuti <em>products</em>, tetapi mengikuti <em>quality</em>.</div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="quiz-section" class="quiz-section">
                <div class="practice-header-card">Prepositional Phrase Agreement Quiz</div>
                <div class="quiz-body">

                    <div class="question-wrapper" data-step="1" style="display: block;">
                        <div class="quiz-progress">1/5</div>
                        <p class="question-text">" The box of chocolates ______ on the table. "</p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="false">A. are</li>
                            <li class="option-item" data-correct="false">B. were</li>
                            <li class="option-item" data-correct="true">C. is</li>
                    ...
                    <div class="question-wrapper" data-step="2" style="display: none;">
                        ...
                        <p class="question-text">" The keys to the car ______ missing yesterday. "</p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="false">A. was</li>
                            <li class="option-item" data-correct="false">B. is</li>
                            <li class="option-item" data-correct="true">C. were</li>
                    ...
                    <div class="question-wrapper" data-step="3" style="display: none;">
                        ...
                        <p class="question-text">" The quality of the products ______ excellent. "</p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="false">A. are</li>
                            <li class="option-item" data-correct="false">B. were</li>
                            <li class="option-item" data-correct="true">C. is</li>
                    ...
                    <div class="question-wrapper" data-step="4" style="display: none;">
                        ...
                        <p class="question-text" style="font-style: normal;">
                            ...
                            The <span class="error-underline">students</span><span class="error-label">A</span>
                            in the <span class="error-underline">class</span><span class="error-label">B</span>
                            <span class="error-underline">is</span><span class="error-label">C</span>
                            studying <span class="error-underline">hard</span><span class="error-label">D</span>.
                        </p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="false">A. students</li>
                            <li class="option-item" data-correct="false">B. class</li>
                            <li class="option-item" data-correct="true">C. is</li>
                            <li class="option-item" data-correct="false">D. hard</li>
                        </ul>
                        <div class="explanation-card">
                            <div class="explanation-title"></div>
                            <p class="explanation-content"></p>
                    ...
                    <div class="question-wrapper" data-step="5" style="display: none;">
                        ...
                        <p class="question-text" style="font-style: normal;">
                            <strong>Identify the ERROR:</strong><br><br>
                            The <span class="error-underline">book</span><span class="error-label">A</span>
                            with many <span class="error-underline">pages</span><span class="error-label">B</span>
                            <span class="error-underline">are</span><span class="error-label">C</span>
                            very <span class="error-underline">interesting</span><span class="error-label">D</span>.
                        </p>
                        <ul class="options-grid">
                            <li class="option-item" data-correct="false">A. book</li>
                            <li class="option-item" data-correct="false">B. pages</li>
                            <li class="option-item" data-correct="true">C. are</li>
                            <li class="option-item" data-correct="false">D. interesting</li>
                        </ul>
                        <div class="explanation-card">
                            <div class="explanation-title"></div>
                            <p class="explanation-content"></p>
        ...
        <div class="materi-right-sticky">
            ...
            <div class="pattern-card">
                <h3>🔍 Agreement Formula</h3>

                <div class="summary-box">
                    <strong>Common Prepositions</strong>
                    of, in, on, at, with, by, to, from, for.
                </div>

                <div class="summary-box">
                    <strong>Syntax Structure</strong>
                    Abaikan prepositional phrase, lalu cocokkan verb dengan subject utama.
                    <span>SUBJECT + (PREP. PHRASE) + VERB</span>
                </div>

                <div class="summary-box">
                    <strong>Quick Verification</strong>
                    <span>The box (of chocolates) is...</span>
                </div>

                <span style="font-size: 0.95rem; opacity: 0.85; display: block; margin-top: 15px; text-align: center; font-style: italic;">
                    Focus on the head noun, ignore the phrase!
                </span>
            </div>
            ...
            <div class="video-card">
                ...
                <div class="video-container">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/4O25LYOrFFs" title="Prepositional Phrase Agreement" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
    ...
    <script>
        const quizDatabase = {
            1: {
                correctText: "Tepat! Subject utama adalah <strong>box</strong>, bukan <em>chocolates</em>. Karena <em>box</em> singular, verb yang benar adalah <strong>is</strong>.",
                wrongText: "Jangan tertipu oleh noun plural di dalam phrase <em>of chocolates</em>. Verb harus mengikuti subject utama <strong>box</strong>, sehingga jawabannya adalah <strong>is</strong>.",
                formula: "The box + (of chocolates) + is"
            },
            2: {
                correctText: "Benar! Subject utama adalah <strong>keys</strong>, bentuknya plural. Phrase <em>to the car</em> tidak memengaruhi verb. Maka verb yang benar adalah <strong>were</strong>.",
                wrongText: "Ingat: abaikan prepositional phrase. Verb tidak mengikuti <em>car</em>, tetapi mengikuti subject utama <strong>keys</strong> yang plural.",
                formula: "The keys + (to the car) + were"
            },
            3: {
                correctText: "Brilian! Subject utama adalah <strong>quality</strong>, bentuknya singular. Kata <em>products</em> hanya berada dalam prepositional phrase, jadi verb yang benar adalah <strong>is</strong>.",
                wrongText: "Ini jebakan TOEFL. Kata <em>products</em> terlihat plural, tetapi bukan subject utama. Subject sebenarnya adalah <strong>quality</strong>, jadi gunakan <strong>is</strong>.",
                formula: "The quality + (of the products) + is"
            },
            4: {
                correctText: "Benar! Bagian C (<em>is</em>) adalah ERROR. Subject utama adalah <strong>students</strong> yang plural, sehingga verb seharusnya <strong>are</strong>.",
                wrongText: "Perhatikan subject utama sebelum phrase. <em>In the class</em> hanyalah prepositional phrase. Karena subject-nya <strong>students</strong>, verb harus plural: <strong>are</strong>.",
                formula: "students + (in the class) + <span style='color:#E74C3C;'>is (SALAH)</span> → <span style='color:#27AE60;'>are (BENAR)</span>"
            },
            5: {
                correctText: "Sempurna! Bagian C (<em>are</em>) adalah ERROR. Subject utama adalah <strong>book</strong>, bentuknya singular. Jadi verb yang benar adalah <strong>is</strong>.",
                wrongText: "Jangan mengikuti kata <em>pages</em> karena kata itu berada di dalam phrase <em>with many pages</em>. Subject utama adalah <strong>book</strong>, maka verb-nya harus <strong>is</strong>.",
                formula: "book + (with many pages) + <span style='color:#E74C3C;'>are (SALAH)</span> → <span style='color:#27AE60;'>is (BENAR)</span>"
            }
        };
        ...
        document.getElementById('btn-next-question').addEventListener('click', function () {
            ...
            if (currentStep <= 5) {
                ...
                alert("🎉 Brilliant! You have mastered Agreement After Prepositional Phrases.");
                currentStep = 1;
