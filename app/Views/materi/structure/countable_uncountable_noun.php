...
<head>
    ...
    <title>Countable and Uncountable Noun</title>
...
<body>
    ...
    <div class="materi-header">
        ...
        <p>Understanding which nouns can be counted directly and which require special quantifiers.</p>
    </div>

    <div class="materi-wrapper">
        <div class="materi-left-scroll">
            <div class="main-card">
                <h2>The Countable vs. Uncountable Rule</h2>
                <p class="intro">In TOEFL Structure, noun choice often depends on whether a noun is <strong>countable</strong> or <strong>uncountable</strong>. Countable nouns can use numbers and plural forms, while uncountable nouns cannot be counted directly and usually stay singular.</p>

                <div class="sub-section">
                    <h3>What is a Countable Noun?</h3>
                    <p>A countable noun names something that can be counted one by one. It can appear in singular or plural form.</p>
                    <p><strong>Examples:</strong> one book, two books, a student, many students, several cars.</p>
                </div>

                <div class="sub-section">
                    <h3>What is an Uncountable Noun?</h3>
                    <p>An uncountable noun names something that is seen as a mass, idea, material, or category. It cannot normally use <em>a/an</em>, numbers, or plural <em>-s</em>.</p>
                    <p><strong>Common TOEFL nouns:</strong> information, advice, furniture, equipment, luggage, homework, research, water, money, traffic.</p>
                </div>

                <div class="sub-section">
                    <h3>TOEFL Style Comparison Examples</h3>
                    <p>These errors are common in TOEFL written expression:</p>
                    <div class="comparison-box">
                        <p><span class="badge-tag">Example 1</span><br>
                            <span class="text-wrong">Incorrect:</span> The teacher gave us many <strong>informations</strong>.<br>
                            <span class="text-correct">Correct:</span> The teacher gave us much <strong>information</strong>.<br>
                            <span class="text-correct">Correct:</span> The teacher gave us a lot of <strong>information</strong>.
                        </p>
                    </div>
                    <div class="comparison-box" style="margin-top: 15px;">
                        <p><span class="badge-tag">Example 2</span><br>
                            <span class="text-wrong">Incorrect:</span> We bought two <strong>equipments</strong> for the lab.<br>
                            <span class="text-correct">Correct:</span> We bought two <strong>pieces of equipment</strong> for the lab.
                        </p>
                    </div>
                </div>
                ...
                <div class="tip-box">
                    ...
                    <p>If the noun is uncountable, do not add <em>-s</em> and do not use <em>many, a few, several, a/an</em>. Use <em>much, a little, some, a lot of</em>, or a measure phrase such as <em>pieces of</em>.</p>
                </div>
            </div>
            ...
            <div id="examples-display-section" class="examples-display-section">
                <div class="example-showcase-card">
                    <h3>Countable and Uncountable Noun Analysis</h3>
                    <div class="example-nav">
                        <button class="ex-tab active" data-target="ex1">Countable</button>
                        <button class="ex-tab" data-target="ex2">Uncountable</button>
                        <button class="ex-tab" data-target="ex3">TOEFL Trap</button>
                    </div>

                    <div class="example-slide active" id="ex1">
                        <div class="sentence-box">There are <span class="hl-modal">many</span> <span class="hl-base">students</span> in the classroom.</div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box"><div class="box-label">Quantifier</div><div class="box-value">many</div><div class="box-desc">Used with countable plural nouns.</div></div>
                            <div class="analysis-box elem-box"><div class="box-label">Countable Noun</div><div class="box-value">students</div><div class="box-desc">Can be counted directly: one student, two students, many students.</div></div>
                        </div>
                    </div>

                    <div class="example-slide" id="ex2">
                        <div class="sentence-box">She gave me <span class="hl-modal">some</span> useful <span class="hl-base">advice</span>.</div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box"><div class="box-label">Quantifier</div><div class="box-value">some</div><div class="box-desc">Can be used with uncountable nouns.</div></div>
                            <div class="analysis-box elem-box"><div class="box-label">Uncountable Noun</div><div class="box-value">advice</div><div class="box-desc">No plural form. Do not write <em>advices</em>.</div></div>
                        </div>
                    </div>

                    <div class="example-slide" id="ex3">
                        <div class="sentence-box">The office needs <span class="hl-modal">two</span> <span class="hl-base">equipments</span>.</div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box"><div class="box-label">Error</div><div class="box-value">two equipments</div><div class="box-desc"><em>Equipment</em> is uncountable, so it cannot take a number directly or plural -s.</div></div>
                            <div class="analysis-box elem-box"><div class="box-label">Correction</div><div class="box-value">two pieces of equipment</div><div class="box-desc">Use a measure phrase when you need to count uncountable nouns.</div></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="quiz-section" class="quiz-section">
                <div class="practice-header-card">Countable & Uncountable Noun Quiz</div>
                <div class="quiz-body">
                    <div class="question-wrapper" data-step="1" style="display: block;">
                        <div class="quiz-progress">1/5</div>
                        <p class="question-text">" I have ______ information regarding the new company policy. "</p>
                        <ul class="options-grid"><li class="option-item" data-correct="false">A. many</li><li class="option-item" data-correct="false">B. a few</li><li class="option-item" data-correct="true">C. a lot of</li><li class="option-item" data-correct="false">D. several</li></ul>
                    ...
                    <div class="question-wrapper" data-step="2" style="display: none;">
                        ...
                        <p class="question-text">" How ______ furniture did they buy for the new office? "</p>
                        <ul class="options-grid"><li class="option-item" data-correct="false">A. many</li><li class="option-item" data-correct="true">B. much</li><li class="option-item" data-correct="false">C. a number of</li><li class="option-item" data-correct="false">D. few</li></ul>
                        <div class="explanation-card"><div class="explanation-title"></div><p class="explanation-content"></p><div class="inner-formula-box"></div></div>
                    </div>

                    <div class="question-wrapper" data-step="3" style="display: none;">
                        <div class="quiz-progress">3/5</div>
                        <p class="question-text">" There are ______ students waiting in the lobby for the seminar. "</p>
                        <ul class="options-grid"><li class="option-item" data-correct="false">A. much</li><li class="option-item" data-correct="false">B. a little</li><li class="option-item" data-correct="true">C. a few</li><li class="option-item" data-correct="false">D. some amount of</li></ul>
                        <div class="explanation-card"><div class="explanation-title"></div><p class="explanation-content"></p><div class="inner-formula-box"></div></div>
                    </div>

                    <div class="question-wrapper" data-step="4" style="display: none;">
                        <div class="quiz-progress">4/5</div>
                        <p class="question-text" style="font-style: normal;"><strong>Identify the ERROR:</strong><br><br>She gave me <span class="error-underline">some</span><span class="error-label">A</span> <span class="error-underline">good advices</span><span class="error-label">B</span> on how to <span class="error-underline">manage</span><span class="error-label">C</span> my <span class="error-underline">time</span><span class="error-label">D</span>.</p>
                        <ul class="options-grid"><li class="option-item" data-correct="false">A. some</li><li class="option-item" data-correct="true">B. good advices</li><li class="option-item" data-correct="false">C. manage</li><li class="option-item" data-correct="false">D. time</li></ul>
                        <div class="explanation-card"><div class="explanation-title"></div><p class="explanation-content"></p><div class="inner-formula-box"></div></div>
                    </div>

                    <div class="question-wrapper" data-step="5" style="display: none;">
                        <div class="quiz-progress">5/5</div>
                        <p class="question-text" style="font-style: normal;"><strong>Identify the ERROR:</strong><br><br>We need to <span class="error-underline">buy</span><span class="error-label">A</span> <span class="error-underline">two equipments</span><span class="error-label">B</span> for the <span class="error-underline">science</span><span class="error-label">C</span> <span class="error-underline">laboratory</span><span class="error-label">D</span>.</p>
                        <ul class="options-grid"><li class="option-item" data-correct="false">A. buy</li><li class="option-item" data-correct="true">B. two equipments</li><li class="option-item" data-correct="false">C. science</li><li class="option-item" data-correct="false">D. laboratory</li></ul>
                        <div class="explanation-card"><div class="explanation-title"></div><p class="explanation-content"></p><div class="inner-formula-box"></div></div>
                    </div>
        ...
        <div class="materi-right-sticky">
            <div class="pattern-card">
                <h3>🔢 Noun Quantity Formula</h3>
                <div class="summary-box"><strong>Countable</strong><span>many / a few / several + plural noun</span></div>
                <div class="summary-box"><strong>Uncountable</strong><span>much / a little / some + noun</span></div>
                <div class="summary-box"><strong>Counting Uncountable</strong><span>number + pieces of + noun</span></div>
                <span style="font-size: 0.95rem; opacity: 0.85; display: block; margin-top: 15px; text-align: center; font-style: italic;">Do not add -s to uncountable nouns!</span>
            </div>
            <div class="video-card"><h3>Video Lesson</h3><p>Watch expert breakdown</p><div class="video-container"><iframe src="https://www.youtube.com/embed/bhgzqbv9Rxk" title="Countable and Uncountable Nouns" allowfullscreen></iframe></div></div>
        </div>
    </div>

    <script>
        const quizDatabase = {
            1: { correctText: "Correct! <strong>Information</strong> is an uncountable noun. <em>A lot of</em> can be used with both countable and uncountable nouns.", wrongText: "<strong>Information</strong> is uncountable, so do not use <em>many, a few,</em> or <em>several</em> with it.", formula: "a lot of + information" },
            2: { correctText: "Right! <strong>Furniture</strong> is uncountable, so the correct question word is <strong>much</strong>.", wrongText: "Use <em>many</em> for countable plural nouns and <em>much</em> for uncountable nouns like furniture.", formula: "How much + uncountable noun" },
            3: { correctText: "Excellent! <strong>Students</strong> is a countable plural noun, so <strong>a few</strong> is correct.", wrongText: "Since <em>students</em> can be counted, use countable quantifiers like <em>a few, many, several</em>.", formula: "a few + countable plural noun" },
            4: { correctText: "Correct! The error is <strong>good advices</strong>. <em>Advice</em> is uncountable and should not take plural -s.", wrongText: "Do not write <em>advices</em>. The correct form is <strong>some good advice</strong> or <strong>pieces of advice</strong>.", formula: "some + good advice" },
            5: { correctText: "Perfect! The error is <strong>two equipments</strong>. <em>Equipment</em> is uncountable, so use <strong>two pieces of equipment</strong>.", wrongText: "Uncountable nouns cannot be counted directly with numbers. Use a measure phrase.", formula: "two pieces of + equipment" }
        };
        ...
        document.getElementById('btn-next-question').addEventListener('click', function () { document.querySelector(`.question-wrapper[data-step="${currentStep}"]`).style.display = 'none'; currentStep++; if (currentStep <= 5) { document.querySelector(`.question-wrapper[data-step="${currentStep}"]`).style.display = 'block'; this.style.display = 'none'; } else { alert("🎉 Great job! You have mastered Countable and Uncountable Nouns."); currentStep = 1; document.querySelectorAll('.question-wrapper').forEach(w => { w.style.display = 'none'; w.removeAttribute('data-answered'); w.querySelector('.explanation-card').style.display = 'none'; w.querySelector('.inner-formula-box').style.display = 'none'; w.querySelectorAll('.option-item').forEach(o => o.className = 'option-item'); }); document.querySelector('.question-wrapper[data-step="1"]').style.display = 'block'; quizSec.style.display = 'none'; btnExercise.classList.remove('btn-active-state'); this.style.display = 'none'; } });
    </script>
</body>
</html>
