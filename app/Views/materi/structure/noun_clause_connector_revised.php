...
<head>
    ...
    <title>Noun Clause Connector</title>
...
<body>
    ...
    <div class="materi-header">
        <h1>Noun Clause Connector</h1>
        <p>Master noun clause connectors and avoid TOEFL word-order traps.</p>
    </div>

    <div class="materi-wrapper">
        <div class="materi-left-scroll">
            <div class="main-card">
                <h2>What is a Noun Clause Connector?</h2>
                <p class="intro">A <strong>noun clause</strong> is a dependent clause that functions as a noun. It can become the subject, object, or complement of a sentence. Noun clause connectors include <em>what, when, where, why, how, who, whoever, that, if,</em> and <em>whether</em>.</p>

                <div class="sub-section">
                    <h3>What is the Main Rule?</h3>
                    <p>After a noun clause connector, the sentence should usually return to normal statement order: <strong>Connector + Subject + Verb</strong>. Do not use question order inside the clause.</p>
                    <div class="comparison-box">
                        <p><span class="badge-tag">Example 1</span><br><span class="text-wrong">Incorrect:</span> I do not know <strong>why did he come</strong> late.<br><span class="text-correct">Correct:</span> I do not know <strong>why he came</strong> late.</p>
                    </div>
                    <div class="comparison-box" style="margin-top: 15px;">
                        <p><span class="badge-tag">Example 2</span><br><span class="text-wrong">Incorrect:</span> She asked <strong>where did they go</strong>.<br><span class="text-correct">Correct:</span> She asked <strong>where they went</strong>.</p>
                    </div>
                </div>

                <div class="sub-section">
                    <h3>TOEFL Style Comparison Examples</h3>
                    <p>Perhatikan perbedaan connector sebagai subject dan connector sebagai penghubung biasa.</p>
                    <div class="comparison-box">
                        <p><span class="badge-tag">Connector as Subject</span><br><span class="text-correct">Correct:</span> <strong>Whoever arrives first</strong> should sign the attendance list.</p>
                    </div>
                    <div class="comparison-box" style="margin-top: 15px;">
                        <p><span class="badge-tag">Yes/No Clause</span><br><span class="text-correct">Correct:</span> The manager needs to know <strong>whether the project is ready</strong>.</p>
                    </div>
                </div>

                <div class="tip-box">
                    <h4>⚠️ TOEFL Exam Shortcut</h4>
                    <p>Jika ada connector seperti <em>what, why, where, how, whether</em>, langsung cek urutan setelahnya. Pola yang benar adalah <strong>Connector + Subject + Verb</strong>, bukan pola tanya.</p>
                </div>
            </div>
            ...
            <div id="examples-display-section" class="examples-display-section">
                <div class="example-showcase-card">
                    <h3>Noun Clause Connector Analysis</h3>
                    <div class="example-nav">
                        <button class="ex-tab active" data-target="ex1">Connector + S + V</button>
                        <button class="ex-tab" data-target="ex2">Connector as Subject</button>
                        <button class="ex-tab" data-target="ex3">TOEFL Trap</button>
                    </div>

                    <div class="example-slide active" id="ex1">
                        <div class="sentence-box">I know <span class="hl-keyword">what</span> <span class="hl-form">he is doing</span>.</div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box"><div class="box-label">Connector</div><div class="box-value">what</div><div class="box-desc">Mengawali noun clause sebagai objek dari kata kerja <em>know</em>.</div></div>
                            <div class="analysis-box elem-box"><div class="box-label">Statement Order</div><div class="box-value">he is doing</div><div class="box-desc">Setelah connector, urutannya tetap Subject + Verb.</div></div>
                        </div>
                    </div>

                    <div class="example-slide" id="ex2">
                        <div class="sentence-box"><span class="hl-keyword">Whoever</span> <span class="hl-form">arrives first</span> should report to the office.</div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box"><div class="box-label">Connector as Subject</div><div class="box-value">whoever</div><div class="box-desc">Connector ini sekaligus menjadi subject dalam noun clause.</div></div>
                            <div class="analysis-box elem-box"><div class="box-label">Clause Function</div><div class="box-value">Subject</div><div class="box-desc">Seluruh klausa menjadi subject dari kalimat utama.</div></div>
                        </div>
                    </div>

                    <div class="example-slide" id="ex3">
                        <div class="sentence-box">I asked where <span class="hl-keyword">did she go</span> last night.</div>
                        <div class="analysis-grid">
                            <div class="analysis-box elem-box"><div class="box-label">Error</div><div class="box-value">did she go</div><div class="box-desc">Ini pola tanya. Dalam noun clause, pola ini salah.</div></div>
                            <div class="analysis-box elem-box"><div class="box-label">Correct Form</div><div class="box-value">where she went</div><div class="box-desc">Gunakan pola pernyataan: connector + subject + verb.</div></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="quiz-section" class="quiz-section">
                <div class="practice-header-card">Noun Clause Connector Quiz</div>
                <div class="quiz-body">
                    <div class="question-wrapper" data-step="1" style="display: block;">
                        <div class="quiz-progress">1/5</div>
                        <p class="question-text">" I really do not know ______ for the meeting yesterday. "</p>
                        <ul class="options-grid">
                                <li class="option-item" data-correct="false">A. why did he come</li>
                                <li class="option-item" data-correct="true">B. why he came</li>
                                <li class="option-item" data-correct="false">C. why he did come</li>
                                <li class="option-item" data-correct="false">D. why came he</li>
                        </ul>
                        ...
                        <p class="question-text">" ______ was late for the lecture is still a mystery. "</p>
                        <ul class="options-grid">
                                <li class="option-item" data-correct="false">A. The person who</li>
                                <li class="option-item" data-correct="true">B. Whoever</li>
                                <li class="option-item" data-correct="false">C. That who</li>
                                <li class="option-item" data-correct="false">D. The one</li>
                        </ul>
                        <div class="explanation-card">
                            <div class="explanation-title"></div>
                            <p class="explanation-content"></p>
                        ...
                        <p class="question-text">" The manager needs to know ______ the project is ready for submission. "</p>
                        <ul class="options-grid">
                                <li class="option-item" data-correct="false">A. that</li>
                                <li class="option-item" data-correct="true">B. whether</li>
                                <li class="option-item" data-correct="false">C. what</li>
                                <li class="option-item" data-correct="false">D. how</li>
                        </ul>
                        <div class="explanation-card">
                            <div class="explanation-title"></div>
                            <p class="explanation-content"></p>
                        ...
                        <p class="question-text" style="font-style: normal;"><strong>Identify the ERROR:</strong><br><br>
                            It is clear <span class="error-underline">that</span><span class="error-label">A</span>
                            <span class="error-underline">what he said</span><span class="error-label">B</span>
                            <span class="error-underline">was</span><span class="error-label">C</span>
                            <span class="error-underline">misunderstood</span><span class="error-label">D</span>.</p>
                        <ul class="options-grid">
                                <li class="option-item" data-correct="true">A. that</li>
                                <li class="option-item" data-correct="false">B. what he said</li>
                                <li class="option-item" data-correct="false">C. was</li>
                                <li class="option-item" data-correct="false">D. misunderstood</li>
                        </ul>
                        <div class="explanation-card">
                            <div class="explanation-title"></div>
                            <p class="explanation-content"></p>
                        ...
                        <p class="question-text" style="font-style: normal;"><strong>Identify the ERROR:</strong><br><br>
                            I asked <span class="error-underline">her</span><span class="error-label">A</span>
                            <span class="error-underline">where</span><span class="error-label">B</span>
                            <span class="error-underline">did she go</span><span class="error-label">C</span>
                            <span class="error-underline">last night</span><span class="error-label">D</span>.</p>
                        <ul class="options-grid">
                                <li class="option-item" data-correct="false">A. her</li>
                                <li class="option-item" data-correct="false">B. where</li>
                                <li class="option-item" data-correct="true">C. did she go</li>
                                <li class="option-item" data-correct="false">D. last night</li>
                        </ul>
                        <div class="explanation-card">
                            <div class="explanation-title"></div>
                            <p class="explanation-content"></p>
        ...
        <div class="materi-right-sticky">
            <div class="pattern-card">
                ...
                <div class="summary-box"><strong>Noun Clause</strong><span>Connector + Subject + Verb</span></div>
                <div class="summary-box"><strong>Example</strong><span>what he is doing</span></div>
            </div>
            <div class="pattern-card">
                <h3>👤 Connector as Subject</h3>
                <div class="summary-box"><strong>Pattern</strong><span>Connector + Verb</span></div>
                <div class="summary-box"><strong>Example</strong><span>Whoever arrives...</span></div>
            </div>
            <div class="video-card">
                <h3>Video Lesson</h3>
                <p>Watch expert breakdown</p>
                <div class="video-container">
                    <iframe src="https://www.youtube.com/embed/9oa6lDJN9Ic" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        const quizDatabase = {
            1: {
                correctText: "Tepat! Dalam noun clause, setelah connector <strong>why</strong>, urutannya harus kembali ke bentuk pernyataan: <strong>subject + verb</strong>. Jadi bentuk yang benar adalah <em>why he came</em>.",
                wrongText: "Jangan gunakan pola pertanyaan di dalam noun clause. Setelah connector seperti <em>why, where, what, how</em>, urutan harus <strong>Subject + Verb</strong>, bukan <em>did he come</em>.",
                formula: "Connector + Subject + Verb → why + he + came"
            },
            2: {
                correctText: "Benar! <strong>Whoever</strong> dapat berfungsi sebagai connector sekaligus subject dari noun clause. Seluruh klausa <em>Whoever was late...</em> menjadi subject kalimat utama.",
                wrongText: "Bagian kosong berada di posisi subject kalimat. Kita membutuhkan noun clause lengkap, dan <strong>whoever</strong> dapat langsung diikuti verb.",
                formula: "[Whoever + Verb] + Main Verb"
            },
            3: {
                correctText: "Sempurna! <strong>Whether</strong> digunakan untuk menunjukkan pilihan atau pertanyaan yes/no di dalam noun clause.",
                wrongText: "Untuk pertanyaan yes/no yang diubah menjadi noun clause, gunakan <strong>if</strong> atau <strong>whether</strong>, lalu ikuti pola Subject + Verb.",
                formula: "whether + Subject + Verb"
            },
            4: {
                correctText: "Tepat! Error ada pada <strong>that</strong>. Kata <em>what he said</em> sudah menjadi noun clause, jadi tidak perlu ditambah <em>that</em> di depannya.",
                wrongText: "Jangan menumpuk dua connector. <em>That what...</em> adalah bentuk redundan. Cukup gunakan <em>What he said...</em>.",
                formula: "<span style='color:#E74C3C;'>that what he said</span> → <span style='color:#27AE60;'>what he said</span>"
            },
            5: {
                correctText: "Brilian! Error ada pada <strong>did she go</strong>. Setelah connector <em>where</em>, noun clause harus memakai pola pernyataan: <em>where she went</em>.",
                wrongText: "Ini jebakan TOEFL paling sering: noun clause tidak boleh memakai inversi pertanyaan. Gunakan Subject + Verb setelah connector.",
                formula: "where + she + went"
            }
        };
